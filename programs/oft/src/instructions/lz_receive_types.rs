...
// account 1 - peer
// account 2 - oft store
// account 3 - to address / wallet address
// account 4 - token dest
// account 5 - token mint
// account 6 - mint authority (optional)
...
impl LzReceiveTypes<'_> {
    pub fn apply(
        ...
        accounts.extend_from_slice(&[
            LzAccount { pubkey: to_address, is_signer: false, is_writable: false }, // 3
            ...
            LzAccount { pubkey: mint_authority, is_signer: false, is_writable: false }, // 6
            LzAccount { pubkey: *token_program, is_signer: false, is_writable: false }, // 7
